...
physical_book1 = PhysicalBook.new(price: 10, available: "yes", book: book20, bookstore: bookstore1, condition: "New")
physical_book1.save!
puts "generated physical book"

physical_book2 = PhysicalBook.new(price: 9, available: "yes", book: book20, bookstore: bookstore2, condition: "New")
physical_book2.save!
puts "generated physical book"

physical_book3 = PhysicalBook.new(price: 12, available: "yes", book: book20, bookstore: bookstore3, condition: "New")
physical_book3.save!
puts "generated physical book"

physical_book4 = PhysicalBook.new(price: 20, available: "yes", book: book5, bookstore: bookstore1, condition: "New")
physical_book4.save!
puts "generated physical book"

physical_book5 = PhysicalBook.new(price: 22, available: "yes", book: book5, bookstore: bookstore2, condition: "New")
physical_book5.save!
puts "generated physical book"

physical_book7 = PhysicalBook.new(price: 22, available: "yes", book: book5, bookstore: bookstore3, condition: "Like New")
physical_book7.save!
puts "generated physical book"

physical_book8 = PhysicalBook.new(price: 22, available: false, book: book5, bookstore: bookstore4, condition: "Like New")
physical_book8.save!
puts "generated physical book"

physical_book6 = PhysicalBook.new(price: 15, available: "yes", book: book1, bookstore: bookstore1, condition: "Like New")
physical_book6.save!
puts "generated physical book"

physical_book9 = PhysicalBook.new(price: 16, available: "yes", book: book1, bookstore: bookstore4, condition: "Like New")
physical_book9.save!
puts "generated physical book"

physical_book10 = PhysicalBook.new(price: 15, available: "yes", book: book6, bookstore: bookstore1, condition: "Like New")
physical_book10.save!
puts "generated physical book"

physical_book11 = PhysicalBook.new(price: 16, available: "yes", book: book6, bookstore: bookstore2, condition: "Like New")
physical_book11.save!
puts "generated physical book"

physical_book12 = PhysicalBook.new(price: 16, available: "yes", book: book6, bookstore: bookstore3, condition: "Like New")
physical_book12.save!
puts "generated physical book"

physical_book13 = PhysicalBook.new(price: 21, available: "yes", book: book6, bookstore: bookstore4, condition: "Like New")
physical_book13.save!
puts "generated physical book"

physical_book14 = PhysicalBook.new(price: 18, available: "yes", book: book2, bookstore: bookstore3, condition: "Like New")
physical_book14.save!
puts "generated physical book"

physical_book15 = PhysicalBook.new(price: 16, available: "yes", book: book2, bookstore: bookstore5, condition: "Good")
physical_book15.save!
puts "generated physical book"

# work on it!
physical_book16 = PhysicalBook.new(price: 27, available: "yes", book: book3, bookstore: bookstore6, condition: "Good")
physical_book16.save!
puts "generated physical book"

physical_book17 = PhysicalBook.new(price: 28, available: "yes", book: book4, bookstore: bookstore3, condition: "Good")
physical_book17.save!
puts "generated physical book"

physical_book18 = PhysicalBook.new(price: 21, available: "yes", book: book7, bookstore: bookstore5, condition: "Good")
physical_book18.save!
puts "generated physical book"

physical_book19 = PhysicalBook.new(price: 19, available: "yes", book: book7, bookstore: bookstore6, condition: "Good")
physical_book19.save!
puts "generated physical book"

physical_book20 = PhysicalBook.new(price: 20, available: "yes", book: book8, bookstore: bookstore4, condition: "Good")
physical_book20.save!
puts "generated physical book"

physical_book21 = PhysicalBook.new(price: 21, available: "yes", book: book8, bookstore: bookstore1, condition: "Good")
physical_book21.save!
puts "generated physical book"

physical_book22 = PhysicalBook.new(price: 11, available: "yes", book: book9, bookstore: bookstore6, condition: "Good")
physical_book22.save!
puts "generated physical book"

physical_book23 = PhysicalBook.new(price: 10, available: "yes", book: book9, bookstore: bookstore1, condition: "Good")
physical_book23.save!
puts "generated physical book"

physical_book24 = PhysicalBook.new(price: 10, available: "yes", book: book9, bookstore: bookstore4, condition: "Acceptable")
physical_book24.save!
puts "generated physical book"

physical_book25 = PhysicalBook.new(price: 37, available: "yes", book: book10, bookstore: bookstore2, condition: "Acceptable")
physical_book25.save!
puts "generated physical book"

physical_book26 = PhysicalBook.new(price: 40, available: "yes", book: book10, bookstore: bookstore6, condition: "Acceptable")
physical_book26.save!
puts "generated physical book"

physical_book27 = PhysicalBook.new(price: 32, available: "yes", book: book11, bookstore: bookstore1, condition: "Acceptable")
physical_book27.save!
puts "generated physical book"

physical_book28 = PhysicalBook.new(price: 20, available: "yes", book: book12, bookstore: bookstore2, condition: "Acceptable")
physical_book28.save!
puts "generated physical book"

physical_book29 = PhysicalBook.new(price: 19, available: "yes", book: book12, bookstore: bookstore3, condition: "Acceptable")
physical_book29.save!
puts "generated physical book"

physical_book30 = PhysicalBook.new(price: 21, available: "yes", book: book13, bookstore: bookstore6, condition: "Acceptable")
physical_book30.save!
puts "generated physical book"

physical_book31 = PhysicalBook.new(price: 20, available: "yes", book: book13, bookstore: bookstore1, condition: "Acceptable")
physical_book31.save!
puts "generated physical book"

physical_book32 = PhysicalBook.new(price: 18, available: "yes", book: book14, bookstore: bookstore4, condition: "Acceptable")
physical_book32.save!
puts "generated physical book"

physical_book33 = PhysicalBook.new(price: 18, available: "yes", book: book14, bookstore: bookstore3, condition: "Poor")
physical_book33.save!
puts "generated physical book"

physical_book34 = PhysicalBook.new(price: 17, available: "yes", book: book14, bookstore: bookstore6, condition: "Poor")
physical_book34.save!
puts "generated physical book"

physical_book35 = PhysicalBook.new(price: 23, available: "yes", book: book15, bookstore: bookstore1, condition: "Poor")
physical_book35.save!
puts "generated physical book"

physical_book36 = PhysicalBook.new(price: 21, available: "yes", book: book15, bookstore: bookstore4, condition: "Poor")
physical_book36.save!
puts "generated physical book"

physical_book37 = PhysicalBook.new(price: 19, available: "yes", book: book16, bookstore: bookstore4, condition: "Poor")
physical_book37.save!
puts "generated physical book"

physical_book38 = PhysicalBook.new(price: 17, available: "yes", book: book16, bookstore: bookstore4, condition: "Poor")
physical_book38.save!
puts "generated physical book"

physical_book39 = PhysicalBook.new(price: 17, available: "yes", book: book17, bookstore: bookstore2, condition: "Poor")
physical_book39.save!
puts "generated physical book"

physical_book40 = PhysicalBook.new(price: 19, available: "yes", book: book17, bookstore: bookstore1, condition: "New")
physical_book40.save!
puts "generated physical book"

physical_book41 = PhysicalBook.new(price: 21, available: "yes", book: book18, bookstore: bookstore3, condition: "New")
physical_book41.save!
puts "generated physical book"

physical_book42 = PhysicalBook.new(price: 20, available: "yes", book: book18, bookstore: bookstore4, condition: "New")
physical_book42.save!
puts "generated physical book"

physical_book43 = PhysicalBook.new(price: 19, available: "yes", book: book19, bookstore: bookstore6, condition: "New")
